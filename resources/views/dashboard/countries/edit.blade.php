...
@section('content')
<form method="POST" action="{{ route('admin.countries.update',$Model) }}" enctype="multipart/form-data" data-parsley-validate novalidate>
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="country_code" id="country_code" class="form-control" required value="{{ $Model['country_code'] }}">
        </div>
        <div class="form-group col-md-6">
            <label for="phone_code">@lang('phone_code')</label>
            <input type="text" name="phone_code" id="phone_code" class="form-control" required value="{{ $Model['phone_code'] }}">
        </div>
        <div class="form-group col-md-6">
            <label for="currancy_code">@lang('currancy_code')</label>
            <input type="text" name="currancy_code" id="currancy_code" class="form-control" required value="{{ $Model['currancy_code'] }}">
        </div>
        <div class="form-group col-md-6">
            <label for="currancy_value">@lang('currancy_value')</label>
            <input type="text" name="currancy_value" id="currancy_value" class="form-control" required value="{{ $Model['currancy_value'] }}">
        </div>
        <div class="form-group col-md-6">
            <label for="phone_length">@lang('phone_length')</label>
            <input type="text" name="length" id="phone_length" class="form-control" required value="{{ $Model['length'] }}">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control " required id="accept_orders" name="status">
                <option {{ $Model['accept_orders'] == 1 ? 'selected' : '' }} value="1">@lang('yes')</option>
                <option {{ $Model['accept_orders'] == 0 ? 'selected' : '' }} value="0">@lang('no')</option>
            </select>
        </div>
        <div class="form-group col-md-6">

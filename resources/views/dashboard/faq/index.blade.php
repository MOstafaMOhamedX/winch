...
<div class="row">
    <div class="my-2 col-6 text-sm-start">
        <a href="{{ route('admin.faq.create') }}" class="btn btn-primary" disabled>@lang('add_new')</a>
    </div>
    <div class="my-2 col-6 text-sm-end">
        <button type="button" id="DeleteSelected" onclick="DeleteSelected('f_a_q_s')" class="btn btn-danger" disabled>@lang('Delete_Selected')</button>
    </div>
</div>
<table class="table table-bordered data-table DataTable">
    <thead>
        <tr>
            ...
            <th style="text-align:center;">@lang('question_ar')</th>
            <th style="text-align:center;">@lang('question_en')</th>

...
<div class="row">
    <div class="my-2 col-6 text-sm-start">
        <a href="{{ route('admin.admins.create') }}" class="btn btn-primary" disabled>@lang('add_new')</a>
    </div>
    <div class="my-2 col-6 text-sm-end">
        <button type="button" id="DeleteSelected" onclick="DeleteSelected('admins')" class="btn btn-danger" disabled>@lang('Delete_Selected')</button>
    </div>
</div>
<table class="table table-sm table-nowrap table-hover card-table text-center DataTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a style="color: #000;" href="{{ route('admin.admins.show', $Model) }}"><i class="fas fa-eye"></i></a>
                <a style="color: #000;" href="{{ route('admin.admins.edit', $Model) }}"><i class="fa-solid fa-pen-to-square"></i></a>
